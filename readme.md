...
- Associable with a Route 53 registered domain
...
| **minecraft_server_jar_url**  | (optional) The URL where your Minecraft server JAR file can be downloaded                                                                    |
| **server_max_memory**         | (optional) The value passed to `-Xmx` flag when starting server.jar; cannot exceed the EC2 instance class memory                             |
| **server_initial_memory**     | (optional) The value passed to `-Xms` flag when starting server.jar; cannot exceed the EC2 instance class memory                             |
